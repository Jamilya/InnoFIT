...
/* ]]> */
  ...
  var data = JSON.parse(localStorage['data']);
    const xValue = d => d.PeriodsBeforeDelivery;
      ...
      const yValue = d => d.MapeForPBD * 100;
      const yLabel = 'MPE';
    ...
    const svg = d3.select('svg');
      ...
      const colorLegend = d3.legendColor()
        ...
        let finalOrder = data.filter((el) => {
          ...
          yScale
                .domain([
                    d3.min([0, d3.min(finalMape, function (d) { return d.MapeForPBD * 100; })]),
                    d3.max([0, d3.max(finalMape, function (d) { return d.MapeForPBD * 100; })])
                ])
            .range([innerHeight, 0])
            .nice();
        ...
        .on('mouseover', function (d) {  // Tooltip
            ...
            .text(function (d) {
               return ' Periods Before Delivery: '+d.PeriodsBeforeDelivery + 
                  '\nMPE of the period: ' + d.MapeForPBD * 100
            });
