        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Visualizations<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li  class = "active"><a href="./mpe.php">Mean Percentage Error (MPE) <span class="sr-only">(current)</span></a></li>
...
/* ]]> */
            ...
            <p> <b>Graph Description: </b> This graph shows the calculation of the Mean Percentage Error (MPE), which is the evaluation of forecasting accuracy, calculated by
               the difference between forecasted customer orders and the final customer orders and divided by the final customer orders. The result is divided by a number of 
                ...
                <br>The formula of the MPE is the following:
                    <img src="https://latex.codecogs.com/gif.latex?MPE_{j} = \frac {\sum_{i=1}^{n}x_{i,j}-x_{i,0}}{\sum_{i=1}^{n}x_{i,0}}" title="MPE formula" /> 
    ...
    <div style="padding-left:39px">    
    <div id ="scatter">
   <!-- <p style="text-align:center;"><strong>MPE graph</strong></p> -->
        ...
        console.log("ndxDim: ", ndxGroup.top(Infinity));
            ...
            dc.renderAll();
               ...
               // console.log("Absolute Difference: ", absValuesArray);
                ...
                xScale
                    .domain([
                        d3.min([0, d3.min(mapeCurrentPBD, function (d) { return d.PeriodsBeforeDelivery; })]),
                        d3.max([0, d3.max(mapeCurrentPBD, function (d) { return d.PeriodsBeforeDelivery; })])
                    ])
          .range([0, innerWidth]);
          //.nice();
          ...
          yScale
                .domain([
                    d3.min([0, d3.min(mapeCurrentPBD, function (d) { return (d.MeanOfThisPeriod )+1; })]),
                    d3.max([0, d3.max(mapeCurrentPBD, function (d) { return (d.MeanOfThisPeriod )+1; })])
                ])
            .range([innerHeight, 0])
            .nice();
        ...
        .on('mouseover', function (d) {  // Tooltip
            ...
            .text(function (d) {
               return ' Periods Before Delivery: '+d.PeriodsBeforeDelivery + 
                  '\nMPE of the period: ' + d.MeanOfThisPeriod 
            });
