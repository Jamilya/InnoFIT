...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li>
                                <a class="dropdown-item " href="./forecastbias.php">Mean Forecast Bias</a>
                            </li>
                            <li>
    ...
    <div style="padding-left:39px">
        ...
        <small>
            ...
            ?></small>
            <br><br>
        <p> NOTE: This graph shows historical customer order amount registered during the period of data upload. <font color="red">(Note: the graph calculation is still under development!)</font></p>
    </div>
    </div>
    ...
    <script>
        ...
        d3.json("/includes/getdata2.php", function (error, data) {
