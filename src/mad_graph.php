...
<body>
    ...
    <div style="padding-left:39px">
        ...
        <small>
            ...
            ?></small>
            <br><br>
        <p> NOTE: This graph shows the calculation of the Mean Absolute Deviation (MAD) of customer orders, which is the average of the absolute deviations from the final orders with respect to periods before delivery (PBD). 
            <br>The formula of the MAD: <img src = "https://ncalculators.com/images/formulas/mean-absolute-deviation.jpg" alt = "MAD_formula" height="55" width="110">, where X is the data set of customer orders, and n is the number of periods. </p>
