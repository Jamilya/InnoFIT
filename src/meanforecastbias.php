                ...
                <ul class="nav navbar-nav">
                    ...
                    <div class="nav-link dropdown">
                        ...
                        <ul class="nav-link dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li>
                                <a class="dropdown-item active" href="./meanforecastbias.php">Mean Forecast Bias (MFB)</a>
                            </li>
    ...
    const svg = d3.select('svg');
      ...
      const colorLegend = d3.legendColor()
        ...
        d3.json("/includes/getdata.php", function (error, data) {
          xScale
          .domain(d3.extent(finalForecastBias, xValue))
          .range([0, innerWidth])
          .nice();
        
          yScale
          .domain(d3.extent(finalForecastBias, yValue))
          .range([innerHeight, 0])
          .nice();
