...
<body>
    ...
    <div class="customContainer text-center">
        ...
        <div class="customContainer text-left">
    ...
    <input type='button' value='Choose file...' onclick="document.getElementById('upload').click();"
        style='background-color:orange;border-radius:5px;margin: 10px 10px 10px 10px' /> -->
                ...
                <div id='fileText' class='content' style="visibility: shown"></div> <br>
                <div id='showdata' class='content'></div><br>
                <button class="btn btn-secondary" id="exportFunction">Export Forecast Error Measures</button>
            </div>
        </div>
    </div>
    <hr>
    ...
    localforage.getItem("viz_data", function(error, data) {
        ...
        let nested2 = d3.nest().key(function(d) {
        ...
        console.log('final error measures:', calculationErrorMeasures, nested.length);
        ...
        function insertOption() {
            ...
            document.getElementById('fileLength').innerHTML = "File length: " + calculationErrorMeasures
                .length + " lines (data points)";
    ...
    <div class="customContainer text-center">
        <div class="row" style="margin-bottom: -2%;">
            <div class="col-md-6">
                <hr>
                <b style="margin-top: 15px;"> PARAMETERS</b> <br>
                <b style="margin-left: 15px;"> Forecast Error Measures</b>
                ...
                <select id='series' name='series' class='main'>
                    ...
                    <option value="8 NRMSE: Norm Root Mean Squared Error">NRMSE: Normalized Root Mean Squared Error
                    </option>
                    <option value="9 RMSE: Root Mean Squared Error">RMSE: Root Mean Squared Error</option>
                </select>

                <br> <b style="margin-left: 15px;"> Clustering methods </b>
...
-->
                ...
                <nobr>
                    <button id="create">Download clustering result</button>
