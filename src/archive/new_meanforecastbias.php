...
<body>
    ...
    <div class="customContainer">
        <div class="row" style="margin-bottom: -2%;">
            <div class="col-md-6">
                <h3>New Mean Forecast Bias (MFB)</h3>
                <small>
                    <?php
        ...
        localforage.getItem("viz_data", function(error, data) {
            ...
            for (let i = 0; i < nested2.length; i++) {
                const uniqueNames = [...new Set(nested2[i].values.map(i => i.Product))];
                // for (let j = 0; j < nested[i].values.length; j++) {
                const currentData = nested2[i].values;
                // const currentProduct = nested2[i].values;
                const currentForecastPeriod = nested2[i].key;
                ...
                for (let j = 0; j < mfbResult.length; j++) {
                    ...
                    calculationErrorMeasures.push({
                        ...
                        // ForecastDate: currentForecastPeriod,
                        MAD: madResult[j].MAD,
                        MD: mdResult[j].MD,
                        MFB: mfbResult[j].MFB,
                        MPE: mpeResult[j].MPE,
            ...
            console.log('final error measures:', calculationErrorMeasures, nested2.length);
            ...
            console.log("finalOrderArray:", finalOrder);
