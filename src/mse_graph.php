        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Visualizations<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li  class = "active"> <a href="./mse_graph.php">Mean Square Error (MSE) <span class="sr-only">(current)</span></a></li>
...
/* ]]> */
    ...
    <div style="padding-left:39px">
    <div id ="scatter">
   <!-- <p style="text-align:center;"><strong>MSE graph</strong></p> -->
   <!-- <span class ="reset" style="display: none;">Range:<span class="filter"></span></span> -->
   <!-- <a class="reset" href="javascript:MSEchart.filterAll(); dc.redrawAll();" style="display: none;">reset</a> -->
...
function myFunction() {
  ...
  if (x.style.display === "none") {
    ...
    let absDiff = function (orignalEl, finalOrder) {
            ...
            // let bubuMap = new Map();
            // absValuesArray.forEach((val) => {
            //     let keyString = val.ActualPeriod;
            //     let valueString = val.AbsoluteDiff;
            //     bubuMap.set(keyString, valueString);
            // });
            // let meanCalc = function (orignalEl) {  return d3.mean(orignalEl.AbsoluteDiff);}
        
            // let bubu = seperatedByPeriods.map((el) => {
            //     let meanValue = meanCalc(el.values, bubuMap.get(el.values.ForecastPeriod));
            //         return {
            //         ActualDate: el.values.ActualDate,
            //         ForecastDate: el.values.ForecastDate,
            //         Product: el.values.Product,
            //         ActualPeriod: el.values.ActualPeriod,
            //         ForecastPeriod: el.values.ForecastPeriod,
            //         OrderAmount: el.values.OrderAmount,
            //         PeriodsBeforeDelivery: el.PeriodsBeforeDelivery,
            //         MeanOfThisPeriod: meanValue
            //         };
            // });
        ...
        var ndx = crossfilter (bubu);
            ...
            var ndxDim = ndx.dimension(function (d) { return  [+d.PeriodsBeforeDelivery, +d.MeanOfThisPeriod, +d.Product];});
            ...
            var ndxGroup = ndxDim.group().reduceSum(function(d) { return +d.MeanOfThisPeriod;});
    ...
    var maxLabel = d3.max(bubu, function(d) { return d.MeanOfThisPeriod; }),
        maxWidth;
    ...
    //     .shape('circle');
        ...
        g.selectAll('circle').data(bubu)
          .enter().append('circle')
            ...
            .attr('stroke','black')
             .attr('stroke-width',1)
             .style("display", function(d) { return d.MeanOfThisPeriod == undefined ? "none" : undefined; })
